...
def input_id_student(root, button_text, select_student):
    ...
    delete_button = ctk.CTkButton(frame, text='Del', fg_color='#d68b26', text_color='#fff', border_width=1, border_color='#000', height=60, command=delete_last_char)
    ...
    clear_button = ctk.CTkButton(frame, text='Clear', fg_color='#d68b26', text_color='#fff', border_width=1, border_color='#000', height=60, command=clear_entry)
    ...
    def generate_ticket(button_text, select_student):
        ...
        if result_student:
            ...
            print(f"Student ID {entered_id} found in the student table.")
...
def open_ticket_window(student_name):
    ...
    print_button = tk.Button(new_window, text="Print Ticket", command=lambda: print_ticket(ticket_number, student_name))
