...
def cashier_window(op_name, op_area):
    ...
    def fetch_queue_data():
        ...
        cursor.execute("SELECT queue_number, purpose_of_visit, affiliation, school_id, full_name, transaction, phone, compilition_time, voided, created_at FROM queue WHERE transaction = 'Cashier Service'")
